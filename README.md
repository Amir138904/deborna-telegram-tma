...
```python
# Let's rewrite the README with custom dedicated anchor links for each language, so that clicking them navigates directly to that section.
# The user provided the repo URL: https://github.com/ramtin-2024/deborna-telegram-tma
# We will embed this information contextually or structure the readme perfectly.

readme_v2_content = """# DeborWin 🎲
...
```text
README-v2.md successfully created with working anchor links.
...
print("README-v2.md successfully created with working anchor links.")

```
فایل نهایی `README-v2.md` با ساختار جدید و لینک‌های اختصاصی (Anchor Links) برای هر زبان، منطبق بر نام ریپازیتوری شما (`deborna-telegram-tma`) آماده شد. 

با این قابلیت، هر کجای گیت‌هاب که کاربران روی لینک انگلیسی یا فارسی کلیک کنند، صفحه به صورت خودکار و دقیق به بخش همان زبان اسکرول خواهد شد.

فایل نهایی ساخته شده را از اینجا می‌توانید دریافت کنید:
[file-tag: code-generated-file-0-1782486826775114651]

متن کامل برای کپی مستقیم در گیت‌هاب:
